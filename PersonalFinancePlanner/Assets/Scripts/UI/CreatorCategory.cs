...
public class CreatorCategory : MonoBehaviour, IDisposable {
    [SerializeField] private Toggle _incomToggle;
    [SerializeField] private Toggle _expenditureToggle;
    ...
    private void CreateSubscribers() {
        _incomToggle.onValueChanged.AddListener(SetIncomType);
        _expenditureToggle.onValueChanged.AddListener(SetExpenditureType);
    ...
    public void Dispose() {
        _incomToggle.onValueChanged.RemoveListener(SetIncomType);
        _expenditureToggle.onValueChanged.RemoveListener(SetExpenditureType);
